...
import { addNote } from "./notesController.js";
...
const server = http.createServer(async (req, res) => {
  ...
  if (req.method === "GET") {
    ...
    req.on("end", () => {
      ...
      // 11. Выполняем ранее созданную комманду, передав туда title (заполняем нашу БД)
      addNote(title);
      // 12. Полученный title - возвращаем клиенту
